...
void ReplayCore(
		...
		Int_t all=-1, //changed by itabashi 0 to -1      //-1=replay all;0=ask for a number
		...
		)
{
  ...
  DefReplayNum=1e9;   //Added by itabashi select all events
